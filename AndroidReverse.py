...
"}")
        ...
        self.FridaPackageList.setMaximumSize(QtCore.QSize(300, 16777215))
...
"width:200px;")
    ...
    def retranslateUi(self, AndroidReversePanel):
        ...
        self.FridaPackageList.setProperty("placeholderText", _translate("AndroidReversePanel", "package"))
