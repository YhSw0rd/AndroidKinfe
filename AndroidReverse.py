...
class Ui_AndroidReversePanel(object):
    def setupUi(self, AndroidReversePanel):
        ...
        self.gridLayout_2.addWidget(self.FridaAttachWay, 0, 2, 1, 1)
        self.FridaStart = QtWidgets.QPushButton(self.FridaTab)
        self.FridaStart.setText("")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("pic/frida-start.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.FridaStart.setIcon(icon5)
        self.FridaStart.setIconSize(QtCore.QSize(20, 20))
        self.FridaStart.setObjectName("FridaStart")
        self.gridLayout_2.addWidget(self.FridaStart, 0, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.FridaDebug, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.FridaSpawnWay, 0, 3, 1, 1)
        self.lineEdit = QtWidgets.QLineEdit(self.FridaTab)
        ...
        self.horizontalLayout.addWidget(self.FridaEditPage)
        self.FridaConsole = QtWidgets.QTextEdit(self.FridaTab)
        self.FridaConsole.setObjectName("FridaConsole")
        self.horizontalLayout.addWidget(self.FridaConsole)
        self.gridLayout.addLayout(self.horizontalLayout, 1, 0, 1, 1)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("pic/tag-r.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.PanelTabs.addTab(self.FridaTab, icon7, "")
    ...
    def retranslateUi(self, AndroidReversePanel):
        ...
        self.DeviceList.setProperty("placeholderText", _translate("AndroidReversePanel", "无连接设备"))
        ...
        self.lineEdit.setPlaceholderText(_translate("AndroidReversePanel", "package"))
